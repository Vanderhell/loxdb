...
typedef enum {
    ...
    MICRODB_BACKEND_REASON_INVALID_CAPABILITY = 1,
    MICRODB_BACKEND_REASON_INVALID_STORAGE_CONTRACT = 2,
    MICRODB_BACKEND_REASON_BYTE_WRITE_NOT_SUPPORTED = 3,
    MICRODB_BACKEND_REASON_MISSING_ALIGNED_ADAPTER = 4,
    MICRODB_BACKEND_REASON_MISSING_MANAGED_ADAPTER = 5
