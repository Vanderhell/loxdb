...
| Core line coverage | Measured locally and blocking CI | 4022/4776 executable lines, 84.21%; CI enforces 83% over the named core and RAM/POSIX port sources. |
...
| ESP32 Arduino bundles | Executed locally | Both source-bundled benchmarks compile for `esp32:esp32:esp32s3` with Arduino-ESP32 3.3.10; no board execution or physical-media test was performed. |
