...
- [done] 10) Modular Backend Packaging + Linker-Friendliness.
...
- [done] Open-time capability vs storage contract fail-fast validation tightened (min-write/erase granularity + managed byte-write gate).
