...
foreach ($name in $targets) {
    $oldSmoke = Get-Budget -Presets $basePresets -PresetName $name -VarName "MICRODB_MANAGED_STRESS_SMOKE_MAX_MS"
    $oldLong = Get-Budget -Presets $basePresets -PresetName $name -VarName "MICRODB_MANAGED_STRESS_LONG_MAX_MS"
    $newSmoke = Get-Budget -Presets $candPresets -PresetName $name -VarName "MICRODB_MANAGED_STRESS_SMOKE_MAX_MS"
    $newLong = Get-Budget -Presets $candPresets -PresetName $name -VarName "MICRODB_MANAGED_STRESS_LONG_MAX_MS"
